...
Trade Dependency Atlas는 국가별 무역·에너지 의존도을 실제 공개 통계로 비교하는 글로벌 통계 플랫폼입니다.
...
Trade Dependency Atlas는 World Bank 공개 데이터와 Natural Earth 지도 경계 데이터를 사용합니다.
...
Trade Dependency Atlas는 The World Bank, Natural Earth, OpenStreetMap, Vercel, Upstash와 제휴, 후원, 승인 관계가 없습니다.

## 면책 고지

Trade Dependency Atlas는 정보 제공, 교육, 연구 목적의 사이트입니다.
...
Trade Dependency Atlas is a global country statistics platform that compares national dependency and supply exposure using public World Bank data.
