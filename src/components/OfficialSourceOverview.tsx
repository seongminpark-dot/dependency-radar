...
const copy = {
  ko: {
    ...
    subtitle:
      "Dependency Radar는 하나의 임의 점수로 국가를 평가하지 않고, 출처별 공식 지표를 분리해 보여줍니다. 각 데이터베이스의 최신 제공 연도는 서로 다를 수 있습니다.",
  ...
  en: {
    ...
    subtitle:
      "Dependency Radar does not rank countries with a single arbitrary score. It separates official indicators by source, because the latest available year can differ across databases.",
  ...
  ja: {
    ...
    subtitle:
      "Dependency Radarは単一の任意スコアではなく、公式指標を出典別に分けて表示します。",
  ...
  zh: {
    ...
    subtitle: "Dependency Radar 按来源分离官方指标，而不是使用单一任意评分。",
  ...
  es: {
    ...
    subtitle: "Dependency Radar separa indicadores oficiales por fuente.",
  ...
  fr: {
    ...
    subtitle: "Dependency Radar sépare les indicateurs officiels par source.",
  ...
  de: {
    ...
    subtitle: "Dependency Radar trennt offizielle Indikatoren nach Quellen.",
