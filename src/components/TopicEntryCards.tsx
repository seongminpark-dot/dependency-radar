        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
          <div>
            ...
            <h2 className="mt-4 max-w-4xl text-4xl font-bold leading-tight text-white">
              {isKo
                ? "궁금한 지표부터 바로 확인하세요."
                : "Start with the indicator you care about."}
            </h2>
            <p className="mt-4 max-w-4xl text-sm leading-7 text-slate-300">
              {isKo
                ? "국가명을 몰라도 연료 수입, 식량 수입, 수입/GDP, 관세율, 에너지 통계 같은 주제별 페이지에서 필요한 정보를 먼저 볼 수 있습니다."
                : "Explore fuel imports, food imports, imports/GDP, tariff rates, and energy statistics before choosing a country."}
            </p>
          </div>
