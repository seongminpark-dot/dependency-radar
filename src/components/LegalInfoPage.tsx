...
const pages = {
  sources: {
    ko: {
      title: "데이터 출처",
      intro: "Trade Dependency Atlas는 World Bank 공개 지표와 Natural Earth 지도 경계 데이터를 사용합니다. 일부 값은 가독성을 위해 재구성, 번역, 정렬, 필터링 또는 시각화될 수 있습니다.",
      sections: [
        {
        ...
        {
          title: "승인 관계 없음",
          body: "Trade Dependency Atlas는 The World Bank, Natural Earth, OpenStreetMap, Vercel, Upstash와 제휴, 후원, 승인 관계가 없습니다.",
        },
      ],
    },
    en: {
      title: "Data Sources",
      intro: "Trade Dependency Atlas uses public World Bank indicators and Natural Earth map boundary data. Some values may be reformatted, translated, sorted, filtered, or visualized for readability.",
      sections: [
        {
          title: "World Bank Open Data",
        ...
        },
        {
          ...
          body: "Trade Dependency Atlas is not affiliated with, sponsored by, or endorsed by The World Bank, Natural Earth, OpenStreetMap, Vercel, or Upstash.",
        },
      ],
    },
    ja: {
      title: "データ出典",
      intro: "Trade Dependency AtlasはWorld Bankの公開指標とNatural Earthの地図境界データを使用します。",
      sections: [
        ...
        { title: "承認関係なし", body: "Trade Dependency Atlasは各データ提供者から後援、承認、提携を受けていません。" },
      ],
    },
    zh: {
      title: "数据来源",
      intro: "Trade Dependency Atlas 使用 World Bank 公共指标和 Natural Earth 地图边界数据。",
      sections: [
        ...
        { title: "无背书关系", body: "Trade Dependency Atlas 未获得数据提供方的赞助、认可或官方背书。" },
      ],
    },
    es: {
      title: "Fuentes de datos",
      intro: "Trade Dependency Atlas utiliza indicadores públicos del World Bank y datos de límites cartográficos de Natural Earth.",
      sections: [
        ...
        { title: "Sin respaldo oficial", body: "Trade Dependency Atlas no está afiliado, patrocinado ni respaldado por los proveedores de datos." },
      ],
    },
    fr: {
      title: "Sources des données",
      intro: "Trade Dependency Atlas utilise des indicateurs publics de la World Bank et des données cartographiques Natural Earth.",
      sections: [
        ...
        { title: "Aucune approbation", body: "Trade Dependency Atlas n’est pas affilié, sponsorisé ou approuvé par les fournisseurs de données." },
      ],
    },
    de: {
      title: "Datenquellen",
      intro: "Trade Dependency Atlas verwendet öffentliche World-Bank-Indikatoren und Natural-Earth-Kartendaten.",
      sections: [
        ...
        { title: "Keine offizielle Unterstützung", body: "Trade Dependency Atlas ist nicht mit den Datenanbietern verbunden, gesponsert oder offiziell unterstützt." },
      ],
    },
  },
  privacy: {
    ko: {
      title: "개인정보처리방침",
      intro: "Trade Dependency Atlas는 사이트 기능 제공에 필요한 최소한의 정보만 사용하도록 설계되었습니다.",
      sections: [
    ...
    en: {
      ...
      intro: "Trade Dependency Atlas is designed to use only the minimum information needed to provide site features.",
      sections: [
    ...
    ja: {
      title: "プライバシーポリシー",
      intro: "Trade Dependency Atlasは必要最小限の情報のみを使用するよう設計されています。",
      sections: [
    ...
    zh: {
      title: "隐私政策",
      intro: "Trade Dependency Atlas 仅使用提供功能所需的最低限度信息。",
      sections: [
    ...
    es: {
      ...
      intro: "Trade Dependency Atlas usa solo la información mínima necesaria para sus funciones.",
      sections: [
    ...
    fr: {
      ...
      intro: "Trade Dependency Atlas utilise uniquement les informations minimales nécessaires.",
      sections: [
    ...
    de: {
      ...
      intro: "Trade Dependency Atlas verwendet nur die minimal notwendigen Informationen.",
      sections: [
  ...
  terms: {
    ko: {
      title: "이용약관",
      intro: "Trade Dependency Atlas는 공개 통계 정보를 교육, 연구, 참고 목적으로 제공합니다.",
      sections: [
    ...
    en: {
      title: "Terms of Use",
      intro: "Trade Dependency Atlas provides public statistical information for educational, research, and reference purposes.",
      sections: [
    ...
    ja: { title: "利用規約", intro: "Trade Dependency Atlasは教育・研究・参考目的で公開統計を提供します。", sections: [{ title: "利用", body: "合法的かつ非妨害的に利用してください。" }, { title: "データ精度", body: "第三者データのため遅延、修正、欠落があり得ます。" }, { title: "禁止事項", body: "データ提供者の承認を装ってはいけません。" }] },
    zh: { title: "使用条款", intro: "Trade Dependency Atlas 提供用于教育、研究和参考的公开统计信息。", sections: [{ title: "使用", body: "用户应合法且不干扰地使用本网站。" }, { title: "数据准确性", body: "数据可能延迟、修订、缺失或不可用。" }, { title: "禁止行为", body: "不得误导性地表示数据提供方认可本网站。" }] },
    es: { title: "Términos de uso", intro: "Trade Dependency Atlas ofrece estadísticas públicas para educación, investigación y referencia.", sections: [{ title: "Uso", body: "El sitio debe usarse de forma legal y no disruptiva." }, { title: "Precisión de datos", body: "Los datos pueden estar retrasados, revisados o incompletos." }, { title: "Uso indebido", body: "No se debe tergiversar el respaldo de los proveedores de datos." }] },
    fr: { title: "Conditions d’utilisation", intro: "Trade Dependency Atlas fournit des statistiques publiques à des fins éducatives, de recherche et de référence.", sections: [{ title: "Utilisation", body: "Le site doit être utilisé légalement et sans perturbation." }, { title: "Exactitude des données", body: "Les données peuvent être retardées, révisées ou incomplètes." }, { title: "Usage interdit", body: "Ne présentez pas les fournisseurs comme approuvant le site." }] },
    de: { title: "Nutzungsbedingungen", intro: "Trade Dependency Atlas bietet öffentliche Statistiken für Bildung, Forschung und Referenz.", sections: [{ title: "Nutzung", body: "Die Website muss rechtmäßig und störungsfrei genutzt werden." }, { title: "Datenqualität", body: "Daten können verzögert, geändert oder unvollständig sein." }, { title: "Missbrauch", body: "Datenanbieter dürfen nicht als Unterstützer dargestellt werden." }] },
  },
  disclaimer: {
    ko: {
      title: "면책 고지",
      intro: "Trade Dependency Atlas는 정보 제공, 교육, 연구 목적의 사이트입니다.",
      sections: [
        ...
        { title: "승인 관계 없음", body: "데이터 제공자는 Trade Dependency Atlas를 후원, 승인, 보증하지 않습니다." },
      ],
    },
    en: {
      title: "Disclaimer",
      intro: "Trade Dependency Atlas is for informational, educational, and research purposes only.",
      sections: [
        ...
        { title: "No endorsement", body: "Data providers do not sponsor, endorse, or approve Trade Dependency Atlas." },
      ],
    },
    ja: { title: "免責事項", intro: "Trade Dependency Atlasは情報提供、教育、研究目的のサイトです。", sections: [{ title: "専門的助言ではありません", body: "投資、法律、貿易、物流、政策助言ではありません。" }, { title: "第三者データ", body: "データには遅延、修正、欠落があり得ます。" }, { title: "承認関係なし", body: "データ提供者は本サイトを承認していません。" }] },
    zh: { title: "免责声明", intro: "Trade Dependency Atlas 仅用于信息、教育和研究目的。", sections: [{ title: "非专业建议", body: "本网站不构成投资、法律、贸易、物流或政策建议。" }, { title: "第三方数据", body: "数据可能延迟、修订、缺失或格式不同。" }, { title: "无背书", body: "数据提供方不赞助、认可或批准本网站。" }] },
    es: { title: "Aviso legal", intro: "Trade Dependency Atlas es solo para fines informativos, educativos y de investigación.", sections: [{ title: "No es asesoramiento profesional", body: "No es asesoramiento de inversión, legal, comercial, logístico o político." }, { title: "Datos de terceros", body: "Los datos pueden estar retrasados, revisados o incompletos." }, { title: "Sin respaldo", body: "Los proveedores de datos no patrocinan ni aprueban Trade Dependency Atlas." }] },
    fr: { title: "Avertissement", intro: "Trade Dependency Atlas est uniquement destiné à l’information, l’éducation et la recherche.", sections: [{ title: "Pas de conseil professionnel", body: "Ce n’est pas un conseil financier, juridique, commercial, logistique ou politique." }, { title: "Données tierces", body: "Les données peuvent être retardées, révisées ou incomplètes." }, { title: "Aucune approbation", body: "Les fournisseurs ne sponsorisent ni n’approuvent Trade Dependency Atlas." }] },
    de: { title: "Haftungsausschluss", intro: "Trade Dependency Atlas dient nur Informations-, Bildungs- und Forschungszwecken.", sections: [{ title: "Keine professionelle Beratung", body: "Es ist keine Anlage-, Rechts-, Handels-, Logistik- oder Politikberatung." }, { title: "Daten Dritter", body: "Daten können verzögert, geändert oder unvollständig sein." }, { title: "Keine Unterstützung", body: "Datenanbieter unterstützen oder genehmigen Trade Dependency Atlas nicht." }] },
  },
};
