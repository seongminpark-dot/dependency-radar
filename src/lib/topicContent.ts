...
export const topics: Topic[] = [
  {
    ...
    descriptionEn:
      "A topic page for checking fuel import exposure and energy-related trade dependency by country.",
  ...
  },
  {
    ...
    descriptionEn:
      "A topic page for checking food and agricultural import exposure by country.",
  ...
  },
  {
    ...
    descriptionEn:
      "A topic page for comparing import exposure relative to economic size.",
  ...
  },
  {
    ...
    descriptionEn:
      "A topic page for comparing tariff rates and trade barrier conditions by country.",
  ...
  },
  {
    ...
    descriptionEn:
      "A topic page for checking country-level energy indicators.",
