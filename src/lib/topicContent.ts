...
export const topics: Topic[] = [
  {
    ...
    descriptionKo: '국가별 연료 수입 비중과 에너지 수입 노출도를 확인하는 주제 페이지입니다. 연료 수입 비중은 에너지 가격 변동, 공급망 충격, 지정학적 리스크를 이해하는 데 참고할 수 있습니다.',
    descriptionEn: 'Compare fuel import dependency and energy-related trade exposure by country.',
  ...
  },
  {
    ...
    descriptionKo: '국가별 식량·농산물 수입 노출도를 확인하는 주제 페이지입니다. 식량 수입 비중은 물가, 공급망 안정성, 식량 안보를 해석하는 데 참고할 수 있습니다.',
    descriptionEn: 'Compare food and agricultural import dependency by country.',
  ...
  },
  {
    ...
    descriptionKo: '국가별 경제 규모 대비 수입 의존도를 비교하는 주제 페이지입니다. 수입/GDP 비중은 한 국가 경제가 해외 공급에 얼마나 연결되어 있는지 이해하는 데 도움이 됩니다.',
    descriptionEn: 'Compare import exposure relative to GDP by country.',
  ...
  },
  {
    ...
    descriptionKo: '국가별 관세율과 무역 장벽을 비교하는 주제 페이지입니다. 관세 데이터는 WITS, WTO, UNCTAD TRAINS, World Bank fallback 기반으로 표시되며 국가별 최신 연도가 다를 수 있습니다.',
    descriptionEn: 'Compare tariff rates and trade barrier conditions by country.',
  ...
  },
  {
    ...
    descriptionKo: '국가별 에너지 지표를 확인하는 주제 페이지입니다. EIA Open Data와 World Bank 구조 지표를 함께 참고해 에너지 노출도와 공급 구조를 해석합니다.',
    descriptionEn: 'Check country-level energy indicators using EIA and World Bank data.',
